            ...
            <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="flex items-center gap-3 text-gray-400 hover:text-yellow-500">
                    <Avatar className="h-8 w-8">
                        <AvatarImage src="https://imgs.search.brave.com/BwGRFG-CLtf-OLXrqqZU5l7sqSe22rt121y_UqTWtQM/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pbWcu/ZnJlZXBpay5jb20v/cHJlbWl1bS12ZWN0/b3IvYnVzaW5lc3Mt/bWFuLWF2YXRhci1w/cm9maWxlXzExMzMy/NTctMjQzMS5qcGc_/c2VtdD1haXNfaHli/cmlkJnc9NzQwJnE9/ODA" />
